...
namespace TestApi.V1.Controllers
{
    ...
    public class TestApiController : BaseController
    {
        ...
        public TestApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
            _getAllUseCase = getAllUseCase;
            _getByIdUseCase = getByIdUseCase;
        }

        //TODO: add xml comments containing information that will be included in the auto generated swagger docs (https://github.com/LBHackney-IT/lbh-test-api/wiki/Controllers-and-Response-Objects)
        /// <summary>
        /// ...
        /// </summary>
