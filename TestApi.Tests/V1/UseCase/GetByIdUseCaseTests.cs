...
namespace TestApi.Tests.V1.UseCase
{
    public class GetByIdUseCaseTests
    {
        ...
        //Guidance on unit testing and example of mocking can be found here https://github.com/LBHackney-IT/lbh-test-api/wiki/Writing-Unit-Tests
    }
}
